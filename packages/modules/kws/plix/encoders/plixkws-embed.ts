 ...
 * (ADR-002):
 *   - 'onnx'        : needs `plixkws-<variant>.onnx` in the module assets
 *                      (see packages/modules/kws/plix/scripts/export-plixkws-onnx.py).
 *                      Default. The `small` export uses external data
